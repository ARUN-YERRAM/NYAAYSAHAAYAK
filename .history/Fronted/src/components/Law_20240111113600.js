            ...
            <Link to="/rights">
                ...
                <Link to="/chatbot">
                    <button class="lawsession">
                        ...
                        <p style={{color:"GrayText"}}>Explore AI-powered solutions to simplify your legal processes and make informed decisions.</p>
                    </button>
                </Link>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <ul class="footer-links "></ul>
                            ...
                            {/* <li><a class="facebook" href="https://www.facebook.com/">facebook<i class="fab fa-facebook-f"></i></a></li>
                            <li><a class="twitter" href="https://twitter.com/i/flow/login">twitter<i class="fab fa-twitter"></i></a></li>
                            <li><a class="dribbble" href="https://dribbble.com/session/new">dribble<i class="fab fa-dribbble"></i></a></li>
                            <li><a class="linkedin" href="https://www.linkedin.com/login">linkedin<i class="fab fa-linkedin-in"></i></a></li> */}
                            {/* </ul>
                            </div>
                            </div>
                            </div>
...
<footer class="site-footer">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <h6 class="text-justify" >About</h6>
                                <p class="text-justify" background-color='black'>At Legal Assistant Services, we are committed to providing expert legal assistance to meet your needs. Our team of experienced professionals is dedicated to delivering high-quality services and ensuring client satisfaction.
