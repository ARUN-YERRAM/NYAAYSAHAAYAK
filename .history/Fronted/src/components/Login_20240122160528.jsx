...
utoComplete='off' name='email' className='form-control rounded-0' 



ong></label>
ord'  name='password' className='form-control'


w-100 rounded-0 margin-bottom-30 margin-top-30'>Log in


g-light rounded-0 text-decoration-none'>Create Account
