         ...
         <header>
           ...
           {localStorage.getItem("userId") ? ( 
                           <>
                             <li className="nav-item">
                             <Link  to="/">
                             <button onClick={()=>{localStorage.removeItem("userId")}} ><i class="fa fa-sign-out"></i> <Login/> Logout</button>
                               </Link>
                             </li>
                           </>
                         ) : (
                           <li className="nav-item" >
                             <Link  to="/login"><button><i class="fa fa-sign-out"></i> <Login/> Sign In</button></Link>
                           </li>
                         )}
            </ul>
                </div>
