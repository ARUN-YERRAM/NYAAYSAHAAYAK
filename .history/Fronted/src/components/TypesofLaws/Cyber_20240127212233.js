const Cyber = () => {
    return ( 
        <>
        <header>CYBER LAW</header>
        <div>
        Cyber law, also known as internet law or digital law, refers to the legal frameworks and regulations that govern activities on the internet and in cyberspace. As technology continues to advance, cyber law becomes increasingly important in addressing issues related to online activities, data protection, digital transactions, and cybercrime.
        </div>
        <div>
          <details >
            ...
            <details>
            <summary> <b>Is registration of marriage compulsory for divorce in Hindu Law? </b></summary>
            <div class="faq__content">
