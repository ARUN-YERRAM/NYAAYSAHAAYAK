  ...
  return (
          ...
          <div class="col-md-4   " style={{marginBottom:"20px", marginTop:"50px"}}>
            <Link to="/Session">
              ...
              <img src="https://content.jdmagicbox.com/comp/def_content/lawyers/default-lawyers-5.jpg" class="Lawyer" alt = "Logo" width="300px" height="270px"/>
            ...
            <div class="detail">
                ...
                <h3 style={{fontSize:"25px"}} size="0a7hBz08qpF2sSkylzLY4qFMUcktjuOfzp5K9edecc0">   name="John Doe"</h3>
          ...
          <div class="col-md-4  " style={{marginBottom:"20px", marginTop:"50px"}}>
            <Link to="/Session">
              <button class="lawsession">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLcnOMPXORO_chgjriJjhkNs8lzHYv2UfUHL6hch8c_JmbFBm-lKs73xkEh_MV7Tdtlo0&usqp=CAU" alt="Logo" width="300px" height="270px"/>
              </button>
        </Link>
