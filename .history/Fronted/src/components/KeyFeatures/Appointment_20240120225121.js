  ...
  const LegalProfessionals = () => (
    <div className="legal-professionals">
      ...
      <div className="card-container">
        ...
        image="https://source.unsplash.com/1600x900/?lawyer,man,boys,portrait,ProfessionaldressOut-fit,serious?David"
        />
        <LegalProfessional
        name="Jane Smith"
        ...
        image="https://source.unsplash.com/1600x900/?lawyer,man,boys,portrait,ProfessionaldressOut-fit,glasses,office?Vicky"
        />
        <LegalProfessional
        name="Mike Johnson"
        ...
        image="https://source.unsplash.com/1600x900/?lawyer,man,boys,portrait,books,ProfessionaldressOut-fit,office?Hussey"
        />
    ...
    <>
      ...
      <div>
        <form className="appointment-form" onSubmit={handleSubmit}>
          ...
          <label htmlFor="Phone.N">Phone No:</label>
          <input type="Phone No" id="Phone" value={Phone} onChange={(e) => setPhone(e.target.value)} required />
