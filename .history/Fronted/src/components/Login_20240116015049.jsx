...
function Login() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('http://localhost:3000/Login', {email,password})mongodb://localhost:27017
...
//     {/* <section id="contact">
//         <h2>Contact Us</h2>
//         <p>Get in touch with us for any legal assistance you may need.</p>
...
//             <input type="email" id="email" name="email" required placeholder="Required"></input>

//             <label for="phone">Mobile Number:</label>
//             <input type="tel" id="phone" name="phone" pattern="[0-9]{10}"></input>

//             <label for="message">Message:</label>
//             <textarea id="message" name="message" placeholder="Write your message here"></textarea>
            
//             <button type="submit" style={{backgroundColor:"#555"}}>Submit</button>
//         </form>
//          </div>
//     </section> */}
...
//             <input type="tel" id="phone" name="phone" required placeholder="Required" pattern="[0-9]{10}"></input>
